...
function ReviewVideoModal({ video, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await api.post(`/reviews/video/${video.id}`, { review, stars });
  ...
  return (
    <div className="modal-overlay">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={`Review ${video.title}`}
      >
        <div className="modal-header">
          <h3>Review: {video.title}</h3>
        ...
        <form className="modal-body" onSubmit={handleSubmit}>
          ...
          <div className="detail-item">
            ...
            <textarea
              id="reviewText"
              rows="6"
              placeholder="Share what you liked (or didn’t) about this video…"
              value={review}
